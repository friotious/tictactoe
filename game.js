class Game {
  ...
  resetGameboard() {
    ...
    Object.keys(this.playerOneSpacesFilled).forEach(
      (v) => (this.playerOneSpacesFilled[v] = false)
    );
    Object.keys(this.playerTwoSpacesFilled).forEach(
      (v) => (this.playerTwoSpacesFilled[v] = false)
    );
    this.turnCounter = 0;
  }
